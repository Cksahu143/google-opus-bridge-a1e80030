...
serve(async (req) => {
  ...
  if (req.method === "POST" && path === "/start") {
    ...
    try {
      ...
      // an iframe. debugUrl is unauthenticated and is explicitly designed
      // for embedding; interactive=true enables remote clicks, scrolling and
      // form input, including login fields on iPad/iPhone.
